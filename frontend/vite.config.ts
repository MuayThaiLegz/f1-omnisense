...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      '/api/jolpica': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/api/openf1': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/api/opponents': { target: 'http://127.0.0.1:8100', changeOrigin: true },
      '/api/driver_intel': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/api/circuit_intel': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/api/pipeline': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/api/f1data': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/api/mccar': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/api/mcdriver': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/api/mcracecontext': { target: 'http://127.0.0.1:8100', changeOrigin: true, rewrite: (path: string) => path.replace(/^\/api\//, '/api/local/') },
      '/3d-models': {
        target: 'http://127.0.0.1:8100',
        changeOrigin: true,
      },
